//A two-level grad-div stabilizations method based on the P1b-P1 element
...
int LNOSi=0, LNOSf=0; //LNOSi and LNOSf are the initial and final arry LNOSa respectively; 
...
for(NOSit=NOSi;NOSit<=NOSf; NOSit++){
     ...
     LNOS=LNOSa[LNOSit];
      ...
      if(mr==4) {Ni=N0;Nf=N4;}   
          for(Rait=Rai;Rait<=Raf;Rait++){
            ...
            string E ="P1b-P1-P1b",S="NC-Two-grid-RCavity-decoupled";
            string R,I,L;
   ...
   fespace Uh1(Th,P1b);Uh1 eh11,eh12,oldeh11,oldeh12,vh11,vh12,u11=u1,u12=u2;//the velocity space
